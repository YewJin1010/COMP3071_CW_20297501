...
def train(env, policy, optimizer, discount_factor, ppo_clip, learning_rate):
    policy.train()
...
def train_a2c_ppo(train_env, test_env): 
    ...
    for episode in range(1, MAX_EPISODES+1):
        ...
        policy_loss, value_loss, train_reward = train(train_env, policy, optimizer, DISCOUNT_FACTOR, PPO_CLIP, LEARNING_RATE)
